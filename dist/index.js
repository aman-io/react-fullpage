...
var FullpageContext = React__default.createContext({
  number: 0,
  count: 0,
  subscribe: null,
  unsubscribe: null,
...
var Fullpage = (_temp = _class = function (_PureComponent) {
  ...
  function Fullpage(props, context) {
    ...
    // refs
    _this.driverRef = React__default.createRef();
    _this.warperRef = React__default.createRef();
    _this.fullpageRef = React__default.createRef();
    return _this;
  }
  ...
  return Fullpage;
}(React.PureComponent), _class.contextType = FullpageContext, _class.propTypes = {
...
}(React.PureComponent), _class$1.contextType = FullpageContext, _class$1.propTypes = {
  children: PropTypes.node.isRequired,
  className: PropTypes.string,
  style: PropTypes.objectOf(PropTypes.oneOfType([PropTypes.number, PropTypes.string, PropTypes.bool]))
...
var FullpageSectionContext = React__default.createContext();
...
}(React.PureComponent), _class$2.contextType = FullpageContext, _class$2.propTypes = {
  children: PropTypes.node.isRequired,
...
}(React.PureComponent), _class$3.contextType = FullpageContext, _class$3.propTypes = {
  style: PropTypes.objectOf(PropTypes.oneOfType([PropTypes.number, PropTypes.string, PropTypes.bool])),
...
}(React.PureComponent), _class$4.contextType = FullpageContext, _temp$4);
...
}(React.PureComponent), _class$5.contextType = FullpageContext, _class$5.propTypes = {
  style: PropTypes.objectOf(PropTypes.oneOfType([PropTypes.number, PropTypes.string, PropTypes.bool]))
